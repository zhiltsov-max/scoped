...
class Scope:
    ...
    def on_error_do(
        ...
        *args,
        ...
        """
        Registers a function to be called upon scope exit because of an error. If called
    ...
    def on_exit_do(
        ...
        *args,
        ...
        """
        Registers a function to be called upon scope exit. If called
        multiple times, callbacks will be called on exit in the reversed order.
    ...
    def add(self, cm: ContextManager[T]) -> T:
        """
        Enters a context manager and adds it to the exit stack. If called
...
def scoped(func, arg_name: Optional[str] = None):
    """
    ...
    The optional arg_name parameter can be specified. If provided, this will be the name
    of the kwarg for the corresponding Scope class instance, that manages this function
    scope. The value is passed automatically, you don't need to pass it manually.
...
def on_error_do(callback, *args, ignore_errors: bool = False, kwargs=None) -> None:
    """
    Registers a function to be called on scope exit because of an error. If called
    multiple times, callbacks will be called on exit in the reversed order.
...
def on_exit_do(callback, *args, ignore_errors: bool = False, kwargs=None) -> None:
    """
    Registers a function to be called on scope exit. If called
    multiple times, callbacks will be called on exit in the reversed order.
